...
public class ArrayListExample {
     ...
     */
    public static <T extends TwoDShape> double total_area(ArrayList<T> twoDList){
     ...
     */
    public static <T extends GeometricShape> void describe_all(ArrayList<T> shapeList){
